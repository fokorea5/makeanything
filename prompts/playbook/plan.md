...
3. 비판 루프 (최대 2회)
   3a. 비판자 소환: .plan.md 비판 요청. 오라클 보고서가 있으면 함께 전달.
   3b. critique_report.md 확인:
       CRITICAL 없음 → 루프 종료, 4단계로.
       CRITICAL 있음 → 오케스트레이터가 .plan.md 수정 → 3a로 (재비판).
   3c. 2회째에도 CRITICAL → 제작자에게 보고하고 판단 요청.
